...
const ProfileContent = ({ active }) => {
  ...
  return (
    <div className="w-full shadow-sm rounded-[10px] p-3 bg-[white] profile profile-pc">
      {/* profile */}
      {active === 1 && (
        <>
...
const Address = () => {
  ...
  return (
    <div className="w-full px-5">
      {open && (
        <div className="fixed w-full h-screen bg-white top-0 left-0 flex items-center justify-center ">
          <div className="w-[35%] h-[80vh] bg-green rounded shadow relative overflow-y-scroll">
      ...
      <div className="flex w-full items-center justify-between">
        ...
        >
          <span className="text-red">Thêm địa chỉ </span>
        </div>
      </div>
      <br />
      {user &&
